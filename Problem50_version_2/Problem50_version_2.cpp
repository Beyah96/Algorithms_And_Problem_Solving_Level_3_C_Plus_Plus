...
vector <stClient> DeleteClientAccountByAccountNumber(vector <stClient> vClients, string DeletedAccountNumber) {
	stClient Client;
	char DeteteAccount;
	if (IsFound(vClients, DeletedAccountNumber, Client)) {
		...
		if (toupper(DeteteAccount) == 'Y') {
			MarkClientForDelete(vClients, DeletedAccountNumber);
...
void UpdateFileAfterDelete(string FileName, string Delim, vector <stClient> vClients, string DetetedAccountNumber) {
	vector <stClient> vTempClients = DeleteClientAccountByAccountNumber(vClients, DetetedAccountNumber);
	fstream MyFile;
